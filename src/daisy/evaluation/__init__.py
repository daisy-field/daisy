...
"""
    ...
    them, check the individual modules for more info.

    At the moment, the toolbox contains a set of classe for the online evaluation of anomaly detection approaches using
    customized extensions of the keras metric API:

        * SlidingWindowEvaluation - Interface class. Implementations must compute incremental updates to the metric.
...
from .anomaly_detection_online_evaluation import ConfMatrSlidingWindowEvaluation, TFMetricSlidingWindowEvaluation
