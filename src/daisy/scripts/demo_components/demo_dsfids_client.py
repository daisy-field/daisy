...
example, the client is configured to process network traffic data from the DSFIDS24
dataset.
...
from daisy.federated_learning import TFFederatedModel, FederatedIFTM, SMAvgTM
