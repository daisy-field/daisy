"""
    ...
    these scripts directly via the command line. Currently the following packaged script-demos are provided:

        * demo_202312 - Centralized OF-IDS demo using a client-server topology, along with the march23 dataset.

    Author: Fabian Hofmann
    Modified: 19.01.24
"""

from .demo_202312 import *
